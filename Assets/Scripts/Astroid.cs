...
public class Astroid : MonoBehaviour
{
    ...
    public void OnDeathAstroid()
    {
        ...
        //babyroidInstance.transform.SetParent(this.transform.parent);
        //hivemind.listOfEnemies.Add(babyroidInstance);
        LevelManager.Instance.EnemyWatcher.Add(babyroidInstance.GetComponent<Hitpoints>());
    }
